  ...
  return (
    <Screen>
      <Wrapper>
        ...
        <Subtitle>
          Cole a letra que deseja formatar no campo abaixo e clique em
          'Formatar'. Ela será formatada e copiada para sua área de
          transferência.
        </Subtitle>
        <TextInput value={lyrics} onChange={(text) => setLyrics(text)} />
        <ButtonWrapper>
          <Button
        ...
        {hasCopied && (
          <Caption>Letra copiada para a área de transferência!</Caption>
        )}
      </Wrapper>
    </Screen>
  );
